  ...
  return (
    <header className="fixed top-4 left-1/2 -translate-x-1/2 z-50 w-full max-w-7xl px-4">
      <nav className="flex items-center justify-between h-12">
        ...
        {/* Right side: Theme toggle, Language toggle, and Social media */}
        <div className="flex items-center h-full gap-2">
          <ThemeToggle />
          <LanguageToggle />
          <a href="https://www.instagram.com/canarycarbon" target="_blank" rel="noopener noreferrer" className="h-full flex items-center px-2 hover:text-primary transition-colors">
          ...
          <a href="https://www.youtube.com/@canarycarbon" target="_blank" rel="noopener noreferrer" className="h-full flex items-center px-2 hover:text-primary transition-colors">
            <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path fillRule="evenodd" d="M19.812 5.418c.861.23 1.538.907 1.768 1.768C21.998 8.746 22 12 22 12s0 3.255-.418 4.814a2.504 2.504 0 0 1-1.768 1.768c-1.56.419-7.814.419-7.814.419s-6.255 0-7.814-.419a2.505 2.505 0 0 1-1.768-1.768C2 15.255 2 12 2 12s0-3.255.417-4.814a2.507 2.507 0 0 1 1.768-1.768C5.744 5 11.998 5 11.998 5s6.255 0 7.814.418ZM15.194 12 10 15V9l5.194 3Z" clipRule="evenodd" />
            </svg>
          </a>
          <a href="https://www.linkedin.com/company/canarycarbon" target="_blank" rel="noopener noreferrer" className="h-full flex items-center px-2 hover:text-primary transition-colors">
            <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
