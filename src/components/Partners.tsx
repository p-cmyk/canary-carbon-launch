...
export function Partners() {
  ...
  const partners = [
    { grey: autoridadPortuariaGrey, white: autoridadPortuariaWhite, alt: "Autoridad Portuaria SC Tenerife" },
    { grey: gobiernoCanariasGrey, white: gobiernoCanariasWhite, alt: "Gobierno de Canarias" },
    { grey: involcanGrey, white: involcanWhite, alt: "INVOLCAN" },
    { grey: turismoCanariasGrey, white: turismoCanariasWhite, alt: "Turismo de Islas Canarias" },
    { grey: universidadLagunaGrey, white: universidadLagunaWhite, alt: "Universidad de La Laguna" },
  ];
    ...
    <section className="py-16 bg-card border-t border-border">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-wrap justify-center items-center gap-12 mb-8">
          {partners.map((partner, index) => (
            <div key={index} className="h-16 flex items-center">
              <img
                src={isDark ? partner.white : partner.grey}
                alt={partner.alt}
        ...
        <p className="text-center text-muted-foreground">
          ...
          <a href="mailto:hello@canary-carbon.com" className="text-primary hover:underline">
            hello@canary-carbon.com
          </a>
        </p>
      </div>
    </section>
